    ...
    return (
        <section className='row'>
            ...
            <div className="col-md-9 m-2">
                <h3 className='text-primary p-2'>Add Bike</h3> <hr />
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="row">
                        <div className="col-md-3">
                            <h6 className='text-primary'>Bike Name</h6>

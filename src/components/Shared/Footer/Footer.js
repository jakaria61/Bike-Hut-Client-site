...
const bikeServices = [
    { name: "Bike Comparisons", link: "/services" },
    { name: "Calculate bike Payments", link: "/services" },
    { name: "Should I Bike purchase", link: "/sercvices" },
            ...
            <div className="container pt-5">
                <div className="row py-5">
                    <div className="col-md-6">
                        ...
                        <p>bike hut is an online leader offering consumer purchase requests and marketing resources to car dealers and manufacturers and providing consumers with the information they need to purchase new and used cars</p>
                    ...
                    <FooterCol key={1} menuTitle="Our Services" menuItems={bikeServices} />
                    <FooterCol key={2} menuTitle="Contacts" menuItems={contacts}>
                        ...
                        <div className='pt-3'>
                            <h6>Hotline</h6>
                            <h3 className='text-primary'>+8801789-714761</h3>
                        </div>
                        <div className='pt-3'>
                            <h6>Email</h6>
                            <h5 className='text-primary'><small>bdjakaria629@gmail.com</small></h5>
                        </div>
                    </FooterCol>
                </div>
                <div className="copyRight text-center">
                    <hr />
                    <p>Copyright {(new Date()).getFullYear()}, Bike hut - All Rights Reserved</p>
                </div>
            </div>
        </footer>
    );
